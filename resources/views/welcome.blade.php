                    ...
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('welcome') }}">
                                <svg class="block h-9 w-auto text-gray-800" viewBox="0 0 24 24">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <a href="{{ route('eventos.index') }}"
                                class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
                                Eventos
                            </a>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <h1 class="text-3xl font-bold text-gray-800 mb-4">
                                Bienvenido a las Jornadas de Videojuegos
                            </h1>
                            <p class="text-gray-600 mb-8">
                                Descubre los mejores eventos, talleres y conferencias sobre videojuegos.
                            </p>
                        </div>
                    </div>
                </div>
